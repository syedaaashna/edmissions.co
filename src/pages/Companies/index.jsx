    ...
    <>
      <div className="bg-white-A700 flex flex-col font-inter items-center justify-start mx-auto pb-[78px] w-full">
        <div className="flex flex-col justify-start w-full">
          ...
          <Text
            className="md:ml-[0] ml-[343px] mt-11 sm:text-[21px] md:text-[23px] text-[25px] text-gray-600"
            size="txtInterSemiBold25Gray600"
          >
            Explore options based on your preferences
          </Text>
          <div className="bg-blue-800 flex md:flex-col flex-row gap-[25px] items-center justify-center md:ml-[0] ml-[313px] mr-[309px] mt-[13px] p-3 md:px-5 rounded-[40px] w-[57%] md:w-full">
            <Img
          ...
          <div className="flex flex-col items-start justify-start md:ml-[0] ml-[331px] mt-[57px] md:px-5">
            <Text
          ...
          <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between max-w-[1380px] mt-[60px] mx-auto md:px-5 w-full">
            <div className="bg-blue_gray-50 border border-black-900 border-solid flex md:flex-1 flex-col justify-start mb-[5px] p-[19px] rounded-[30px] shadow-bs w-[23%] md:w-full">
              <Img
            ...
            <div className="bg-gray-100_01 flex md:flex-1 flex-col items-center justify-start md:mt-0 mt-[5px] p-[7px] rounded-[30px] shadow-bs w-[23%] md:w-full">
              <Img
            ...
            <div className="bg-gray-100_01 flex md:flex-1 flex-col justify-start md:mt-0 mt-[5px] p-[15px] rounded-[30px] shadow-bs w-[23%] md:w-full">
              <Img
